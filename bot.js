...
// playing
client.on('ready', () => {                           
client.user.setGame(`WG | -help`,'https://www.twitch.tv/ℕ g A M Codes♥');
  });
...
client.on("message", message => {
 if (message.content === "$support") {
  const embed = new Discord.RichEmbed()
      ...
      .setColor("RANDOM")
      .setFooter('WG System جميع الحقوق محفوظة 2019 لبوت')  
      .addField('سيرفر الدعم الفني', ` https://discord.gg/rHEVhpk  `)
...
client.on('message', message => {
              var prefix = "-" ;
  if (message.content.startsWith(prefix + "Wael")) {
  if(message.author.id !== "352533519068823556") return message.reply('**You aren\'t the bot owner.**');
  let embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setDescription(`
...
client.on("ready", () => { // كود رينبو
  function lol() {
    client.guilds.get('536490569396912128').roles.find("name", "Rainbow").setColor("RANDOM");
  };
